...
from sqlalchemy.exc import ProgrammingError  # 👈 agregado
...
async def ensure_panel_access_seed(db: AsyncSession) -> None:
    try:
        ...
        # ⚠️ Si las tablas aún no existen (primer arranque antes de migraciones), omitir sin fallar
        print("⚠️ Tabla permissions o users no encontrada aún, se omitió el seed inicial.")
